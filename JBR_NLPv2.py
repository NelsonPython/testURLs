...
Version 1:  reads files from one folder
Version 2:  reads files from a list of files that may be in multiple folders
"""
...
if __name__ == '__main__':
    grammarFile = 'JBR_Resources/grammarWords.txt'
    longwordsFile = "/home/iotahub/testIOTADocs/Results/NLPv2_complexWords.txt"
    totWordsFile = "/home/iotahub/testIOTADocs/Results/NLPv2_totWordcount.txt"
    outputFilename = "/home/iotahub/testIOTADocs/Results/NLPv2_docStats.csv"
    summaryFile = "/home/iotahub/testIOTADocs/Results/NLPv2_summary.txt"
    # Version 2 reads all files from a list of filenames
    with open("/home/iotahub/testIOTADocs/docsFiles.txt") as filenames:
        Documnts = ["/home/iotahub/"+filename for filename in filenames]
